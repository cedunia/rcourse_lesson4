...
extinct_seriesxalignment.glm <- glm(extinct ~ series * alignment,
                                    family = "binomial", data = data_stats)
...
extinct_seriesxalignment_tng.glm <- glm(extinct ~ relevel(series,"tng") * alignment,
                                        family = "binomial", 
                                        data = data_stats)
